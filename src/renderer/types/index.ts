import type { OfficeTaskWithArtifacts } from '../../shared/office-tasks';
export type {
  OfficeArtifact,
  ...
  OfficeTask,
  OfficeTaskDetailLevel,
  OfficeTaskLanguage,
  OfficeTaskOptions,
  OfficeTaskOutputFormat,
...
export type ServerEvent =
  ...
  | { type: 'office-task.update'; payload: OfficeTaskWithArtifacts }
  | {
